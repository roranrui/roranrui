...
![001_vi键盘-w551](https://cdn.jsdelivr.net/gh/roranrui/img_bed/img/001_vi%E9%94%AE%E7%9B%98.png)
...
![002_删除交换文件-w1048](https://cdn.jsdelivr.net/gh/roranrui/img_bed/img/002_%E5%88%A0%E9%99%A4%E4%BA%A4%E6%8D%A2%E6%96%87%E4%BB%B6.png)
...
![003_vi的模式-w500](https://cdn.jsdelivr.net/gh/roranrui/img_bed/img/003_vi%E7%9A%84%E6%A8%A1%E5%BC%8F.png)
...
![005_移动光标-w551](https://cdn.jsdelivr.net/gh/roranrui/img_bed/img/005_%E7%A7%BB%E5%8A%A8%E5%85%89%E6%A0%87.png)
...
![004_插入命令-w400](https://cdn.jsdelivr.net/gh/roranrui/img_bed/img/004_%E6%8F%92%E5%85%A5%E5%91%BD%E4%BB%A4.png)
...
4. 输入 `I` 进入 **编辑模式**(光标前输入)，并在 **行首插入**，注意：一定要使用 **I**(`a`是在光标后输入)
5. 输入 `# ` 也就是注释符号
...
![vi](https://cdn.jsdelivr.net/gh/roranrui/img_bed/img/vim.png)
...
`syntax on/off` 控制着色开关



#### 2_计算器

编辑模式下按下`ctrl + r`, 然后输入`=`, 输入需要计算的内容
...
`:x`: 文件没有被修改, 表示直接退出, 文件修改情况下, 表示保存并退出(:wq会刷新文件的更新时间, 即使没有修改文件)
